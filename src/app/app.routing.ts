...
const APP_ROUTES: Routes = [
  ...
  {path: 'admin/user/new', component: AdminCreateUserComponent, canActivate: [AdminServiceClient], pathMatch: 'full'},
  {path: 'admin/user/:userId', component: AdminEditUserComponent, canActivate: [AdminServiceClient], pathMatch: 'full'},
